...
public class TransactionAdviceConfig {
     ...
     * 定义切点路径
     */
    private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.fh.service.impl.*.*(..))";
    ...
    public TransactionInterceptor TxAdvice() {
        ...
        txMap.put("a*", transactionAttribute1);
        txMap.put("c*", transactionAttribute1);
        txMap.put("d*", transactionAttribute1);
        txMap.put("b*", transactionAttribute1);
        txMap.put("u*", transactionAttribute1);
        txMap.put("s*", transactionAttribute1);
        txMap.put("q*", transactionAttribute1);
